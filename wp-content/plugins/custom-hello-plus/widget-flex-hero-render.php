<?php
/**
 * Plugin Name: Custom Hello Plus
 * Description: Customizations for Hello Plus plugin.
 * Version: 1.0
 * Author: Goran Subic
*/

// Load your customizations here

// add_filter('hello_plus_render_text_container', 'custom_render_text_container');
// function custom_render_text_container($content) {
//     // Modify the content as needed
//     return '<div class="custom-text-container">AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAa ' . $content . '</div>';
// }
